...
Revision ID: 5e94aae498b4
Revises: 
Create Date: 2024-08-28 16:04:54.949026
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['receive_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['request_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('request_id', 'receive_id')
    )
    ...
    sa.ForeignKeyConstraint(['message_id'], ['main.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.drop_table('user')
